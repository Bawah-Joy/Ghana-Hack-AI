...
const crops = [
  {
    ...
    // image: <Image source={require('../../assets/images/maize.jpg')} style={{ width: 100, height: 100 }} />,
    color: "#FFA500",
    icon: "pagelines" as const,
  },
  {
    id: "tomato",
    name: "Tomato",
  ...
  },
  {
    id: "cashew",
    name: "Cashew",
    image: require("../../assets/images/cashews.png"),
    color: "#32CD32",
    icon: "leaf" as const,
  },
];
    ...
    >
      ...
      >
        ...
        >
          <Image
            source={
              typeof crops[selectedCrop].image === "string"
                ? { uri: crops[selectedCrop].image }
                : (crops[selectedCrop].image as number)
            }
